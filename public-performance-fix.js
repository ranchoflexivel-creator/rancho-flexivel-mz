// Public-page resilience layer kept intentionally lightweight.
// app.js remains the single owner of products, categories, kits and FAQ.
(() => {
  const fillFallbacks = () => {
    ...
    if (steps && !steps.children.length) steps.innerHTML = [
      ['1','Escolha','Pesquise produtos e compare preços.'],['2','Monte o carrinho','Ajuste quantidades e veja o total.'],['3','Envie o pedido','Envie o pedido pelo WhatsApp.'],['4','Acompanhe','A equipa confirma e actualiza o estado.']
  ...
  // Never poll or query Supabase here. app.js owns the real data and images.
  setTimeout(fillFallbacks, 1500);
})();
